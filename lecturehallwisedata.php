...
$branchq="SELECT distinct department from trisub where classroom='$class'";
$retvalbranch=mysqli_query($conn,$branchq);
$yearq="SELECT distinct year from trisub where classroom='$class'";
...
?>
  <div class="panel panel-default">
    ...
    <table class="table  main-table" border="2"><!--this table is also appear from database-->
      <?php
      ...
      ?>
  <center><h2 class="table-header"><!--lecture hall is appear from database--></h2></center>
...
$count1=1; ?>
  ...
  <table class="table table-hover" border="3">
    ...
    ?>
    <tr>
      <td><?php $no1=$rownum1['enrollnumber']; echo $no1;  ?></td>
      <td><?php $no2=$rownum2['enrollnumber']; echo $no2;  ?></td>
    </tr>
    <?php $count=$count+1;} ?>
  </table>
</td>
